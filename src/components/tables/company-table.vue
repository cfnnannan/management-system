<template>
    <div class="table-container">
        <div class="content">
            ...
            <div class="dialog">
                <el-dialog title="公司编辑" :visible.sync="dialogFormVisible">
                    <edit-popup @closeEdit="dialogFormVisible=false" :source="'fromCompany'" :companyId="companyId"></edit-popup>
                </el-dialog>
            </div>
        </div>
    </div>
